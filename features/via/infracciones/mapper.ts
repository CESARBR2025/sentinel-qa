...
export const mapInfraccionDetalle = (row: any): InfraccionDetalleDTO => {
  ...
  return {
    ...
    nombreTitular: [row.nombre_titular_liberacion, row.appaterno_titular_liberacion, row.apmaterno_titular_liberacion].filter(Boolean).join(" "),
    ...
    gruaLatitud: row.grua_latitud,
    gruaLongitud: row.grua_longitud,
    gruaDireccion: row.grua_direccion,
    latitud: row.latitud,
