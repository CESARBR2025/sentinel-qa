...
| Nota | Descripción |
|------|-------------|
| [Comandos](🛠%20Stack/Comandos.md) | Comandos útiles (dev, build, lint, etc.) |
| [Convenciones](🛠%20Stack/Convenciones.md) | Patrones y reglas de código |
| [Librerias](🛠%20Stack/Librerias.md) | Dependencias y versiones |
| [Variables de Entorno](🛠%20Stack/Variables%20de%20Entorno.md) | Variables de entorno requeridas |

## 📦 Datos
| Nota | Descripción |
|------|-------------|
| [Esquema BD](📦%20Datos/Esquema%20BD.md) | Tablas, columnas, relaciones, enums |

## 🗺 Roadmap
| Nota | Descripción |
|------|-------------|
| [Changelog](🗺%20Roadmap/Changelog.md) | Historial de cambios cronológico |
| [Pendientes](🗺%20Roadmap/Pendientes.md) | Próximas features y bugs conocidos |

## 📡 API
| Nota | Descripción |
|------|-------------|
| [API Routes](📡%20API/API%20Routes.md) | Endpoints RESTful |
| [Server Actions](📡%20API/Server%20Actions.md) | Catálogo de server actions |

## 📚 Referencias
| Nota | Descripción |
|------|-------------|
| [Glosario](📚%20Referencias/Glosario.md) | Términos del dominio |
