...
10. Cada unidad despachada (`incidente_despacho_unidades`) registra su propia `hora_salida`/`hora_llegada`, capturadas desde el tablón de despacho (tab "En Despacho") vía `marcarHoraUnidadDespacho` — independiente del cambio de estatus del incidente completo
