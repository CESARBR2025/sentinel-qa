...
export async function obtenerLiberaciones() {
  return query<Record<string, unknown>>(`
    ...
    WHERE (estatus_dependencia IN ('LIBERADA_POR_INFRACCION', 'VEHICULO_EN_CORRALON', 'LIBERADA_POR_DELITO', 'LIBERADA_POR_ACCIDENTE', 'FINALIZADA_ACCIDENTE', 'FINALIZADA_INFRACCION', 'FINALIZADA_DELITO')
       OR (estatus = 'REGISTRADA' AND estatus_dependencia IN ('MESA_DE_CONTROL_REVISION', 'MESA_DE_CONTROL_PENDIENTE_DOCS', 'MESA_DE_CONTROL_RECHAZADA'))
       OR (estatus = 'PENDIENTE_PAGO' AND estatus_dependencia IN ('PENDIENTE_PAGO_LIBERACION', 'LIBERACION_EN_PROCESO', 'LIBERACION_PENDIENTE_DOCUMENTOS'))
