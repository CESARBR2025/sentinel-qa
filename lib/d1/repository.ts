...
export async function insertarReporteDenuncia(params: Record<string, unknown>): Promise<string> {
  ...
  const result = await query<{ id: string }>(
    `INSERT INTO ofi_reporte_denuncia (
      ...
      policia_a_cargo, nomina_mando, policia_denuncia, policia_firma_d1, policia_ingresa_cu,
    ...
    [
      ...
      params.policiaACargo, params.nominaMando, params.policiaDenuncia, params.policiaFirmaD1, params.policiaIngresaCu,
