...
export default async function SolicitudesPage() {
  ...
  const { pendientes, enProceso, conMonitorista } = await obtenerSolicitudes()
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b', fontFamily: 'Inter,sans-serif' }}>
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '32px 48px', display: 'flex', flexDirection: 'column', gap: 32, minHeight: '100vh' }}>
        ...
        {/* Tabs + Tables */}
        <TabSolicitudes pendientes={pendientes} enProceso={enProceso} conMonitorista={conMonitorista} />
