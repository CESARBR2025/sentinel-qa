  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b', fontFamily: 'Inter,sans-serif' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 48px', display: 'flex', flexDirection: 'column', gap: 32, minHeight: '100vh' }}>
        ...
        <Link href="/agente_juzgado/detenidos" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#64748b', fontFamily: 'JetBrains Mono,monospace', fontSize: 10, textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.08em', width: 'fit-content' }}>
          <ArrowLeft size={14} /> Regresar a detenidos
        </Link>
        <Link href="/agente_juzgado" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, color: '#94a3b8', fontFamily: 'JetBrains Mono,monospace', fontSize: 9, textDecoration: 'none', marginLeft: 16 }}>
          ← Menú Juzgado
        </Link>
        ...
        <div style={{ marginTop: 'auto', paddingTop: 20, borderTop: '1px solid #e2e8f0', fontFamily: 'JetBrains Mono,monospace', fontSize: 10, color: '#94a3b8', letterSpacing: '0.18em', textTransform: 'uppercase', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <span>SENTINEL v0.1 · JUZGADO · DETENIDO</span>
