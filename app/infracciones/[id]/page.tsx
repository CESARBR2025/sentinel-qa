...
export default async function InfraccionCiudadanoPage({
    ...
    const hasCoords = infraccion.latitud && infraccion.longitud &&
    ...
    const mostrarPago = infraccion.estatusInfraccion === 'PENDIENTE_PAGO' && (
        ...
        infraccion.estatusDependencia === 'PENDIENTE_PAGO_INFRACCION'
    );
        ...
        <main className="min-h-dvh overflow-x-hidden bg-slate-100">
            ...
            <div className="max-w-4xl mx-auto px-6 -mt-5 relative z-10 pb-10 space-y-5">
                ...
                <Card>
                    ...
                    {hasCoords && (
                        <div className="mt-5">
                            <MapSectionCiudadano lat={Number(infraccion.latitud)} lng={Number(infraccion.longitud)} />
                        </div>
                    )}
                </Card>
            </div>
...
function FieldWithIcon({ icon: Icon, label, value }: {
...
function MontoRow({ label, value, valueClass = 'text-slate-900' }: {
