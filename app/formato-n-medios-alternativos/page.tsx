...
export default async function FormatoNMediosAlternativosPage({
  ...
  return (
    <div style={{ ...pageWrap, display: 'flex', flexDirection: 'column' }}>
      ...
      <DashboardHeader user={user} roleLabel="Medios Alternativos" backHref="/envio-de-formatos" backLabel="Envío de Formatos" />
      ...
      <main className="pad-pagina" style={{ width: '100%', flex: 1, display: 'flex', flexDirection: 'column', gap: 24 }}>
        <PageHeader
          ...
          actions={
            <PageHeaderLink href="/formato-n-medios-alternativos/nuevo">
            ...
            <tbody>
              ...
              {registros.map(r => (
                <tr key={r.id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                  ...
                  <Td><Link href={`/formato-n-medios-alternativos/${r.id}`} style={{ fontFamily: 'JetBrains Mono', fontSize: 10, color: '#1f355a', textDecoration: 'none' }}>EDITAR</Link></Td>
                </tr>
              ))}
            </tbody>
          </table>
