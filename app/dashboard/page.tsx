...
export default async function DashboardPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b', fontFamily: 'Inter,system-ui,sans-serif', position: 'relative', overflowX: 'clip' }}>
      <style>{`
        ...
        .top-shutter { 
          top: 0; border-bottom: 2px solid #3e5171; 
          box-shadow: 0 10px 40px rgba(212,164,58,0.15);
          animation: openTop 0.5s cubic-bezier(0.8, 0, 0.2, 1) forwards; 
        }
        .bottom-shutter { 
          bottom: 0; border-top: 2px solid #3e5171; 
          box-shadow: 0 -10px 40px rgba(212,164,58,0.15);
          animation: openBottom 0.5s cubic-bezier(0.8, 0, 0.2, 1) forwards; 
        }
        .shutter-acc { position: absolute; left: 50%; transform: translateX(-50%); width: 140px; height: 4px; background: #3e5171; }
        ...
        @keyframes dataReveal {
          ...
          100% { clip-path: inset(-40px -40px -40px -40px); opacity: 1; transform: translateX(0); }
        }
        ...
        .grid-bg {
          ...
          background-image: 
            linear-gradient(rgba(62, 81, 113, 0.1) 1px, transparent 1px), 
            linear-gradient(90deg, rgba(62, 81, 113, 0.1) 1px, transparent 1px);
        ...
        <div className="dashboard-grid" style={{ flex: 1 }}>
          ...
          <div className="cyber-reveal delay-2">
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
              <div style={{ width: 4, height: 16, background: '#3e5171' }}></div>
          ...
          <div className="cyber-reveal delay-3" style={{
            ...
            <div style={{
              ...
              {/* Decorators */}
              <div style={{ position: 'absolute', top: 0, left: 0, width: 20, height: 20, borderTop: '2px solid rgba(62, 81, 113, 0.3)', borderLeft: '2px solid rgba(62, 81, 113, 0.3)' }}></div>
              <div style={{ position: 'absolute', bottom: 0, right: 0, width: 20, height: 20, borderBottom: '2px solid rgba(62, 81, 113, 0.3)', borderRight: '2px solid rgba(62, 81, 113, 0.3)' }}></div>
