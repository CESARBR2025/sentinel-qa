    ...
    <div style={{ maxWidth: 860 }}>
      ...
      <div style={{ marginBottom: 32 }}>
        <h2 style={{ fontFamily: 'Barlow Condensed,sans-serif', fontWeight: 800, fontSize: 28, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#d8e0f0', margin: '0 0 6px' }}>
          Nueva <span style={{ color: '#d4a43a' }}>Medida de Protección</span>
        </h2>
...
function Field({ label, name, type = 'text', required, placeholder }: {
  ...
  return (
    <label style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
      <span style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: 9, color: '#8a9bc0', letterSpacing: '0.15em', textTransform: 'uppercase' }}>
        {label}
      </span>
      <input
