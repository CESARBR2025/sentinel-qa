...
import { obtenerDetalleInfraccionInfracciones } from '@/lib/agente_infracciones/actions'
...
export default async function DetalleInfraccionPage({
  ...
  const result = await obtenerDetalleInfraccionInfracciones(id)
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b', fontFamily: 'Inter,sans-serif' }}>
      ...
      <DashboardHeader
        ...
        backHref="/agente_infracciones"
        backLabel="Infracciones"
      />
      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '32px 48px', display: 'flex', flexDirection: 'column', gap: 32 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <span>CENTINELA {APP_VERSION} · INFRACCIONES · DETALLE</span>
