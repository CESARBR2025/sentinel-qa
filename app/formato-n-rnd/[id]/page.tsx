  ...
  return (
    <div style={{ ...pageWrap, display: 'flex', flexDirection: 'column' }}>
      <style>{fontsImport}</style>
            <DashboardHeader roleLabel="Editar Inscripción" />
      <PageHeader
        title="Editar"
        accent="Inscripción"
        subtitle="Formato N a Coordinación"
        actions={<PageHeaderLink href="/formato-n-rnd" variant="secondary">← Registro Nacional de Detenciones</PageHeaderLink>}
      />
