...
export async function GET(req: NextRequest) {
  ...
  const COLS = tipo === 'semanal'
    ? [
        ...
        { header: 'Cateo FGE',      key: 'cateoFge',    width: 12 },
        { header: 'Operativos',     key: 'operativos',   width: 12 },
        { header: 'Cateo FGR',      key: 'cateoFgr',    width: 12 },
        { header: 'FGR',            key: 'fgr',          width: 10 },
        { header: 'Armas Fuego',    key: 'armasFuego',  width: 14 },
        { header: 'Armas Blancas',  key: 'armasBlancas', width: 14 },
