    ...
    <main style={{ minHeight: '100vh', background: '#f8fafc', color: '#1e293b' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 32px', display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        {prefill.reporteCampoId && (
          <div style={{ padding: '12px 20px', background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 2, fontFamily: 'JetBrains Mono', fontSize: 11, color: '#1d4ed8', display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
