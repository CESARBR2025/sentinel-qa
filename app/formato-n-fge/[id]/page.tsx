...
export default function EditarFormatoNFgePage() {
  ...
  useEffect(() => {
    fetch(`/api/reportes/formato-n-fge/${id}`)
      .then(r => r.json())
      .then(data => {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(`/api/reportes/formato-n-fge/${id}`, {
        method: 'PATCH',
  ...
  return (
    <div style={pageWrap}>
      ...
      <SubHeader backHref="/formato-n-fge" backLabel="Eventos FGE" title="Editar Reporte" />
