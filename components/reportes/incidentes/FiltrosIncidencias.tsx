    ...
    <section style={styles.filterCard}>
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr auto auto', gap: '20px', alignItems: 'flex-end' }}>
        <div>
          ...
          <select 
            style={{...styles.input, appearance: 'none', cursor: 'pointer', fontWeight: 600}} 
            value={tipo} 
            onChange={e => setTipo(e.target.value)}
          >
            <option value="diario">DIARIO (3 CAMPOS)</option>
            <option value="semanal">SEMANAL (11 CAMPOS)</option>
          </select>
        </div>
        <div>
