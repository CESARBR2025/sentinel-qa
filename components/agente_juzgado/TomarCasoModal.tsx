...
import { accionTomarCaso } from '@/lib/agente_juzgado/actions'
          ...
          >
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{
                ...
                Al recibir este caso, la solicitud pasará a <strong>EN_REVISIÓN</strong> y se moverá a la sección correspondiente. ¿Deseas continuar?
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
                ...
                >
                  {pending ? 'Procesando...' : 'Recibir Caso'}
                </button>
              </div>
            </form>
          </div>
