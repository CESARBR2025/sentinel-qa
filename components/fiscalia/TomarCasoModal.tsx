...
export function TomarCasoBoton({ solicitudId }: { solicitudId: string }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await accionTomarCaso(new FormData(form))
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <div style={{ position: 'absolute', top: 0, left: 0, width: 48, height: 3, background: '#7c3aed' }}></div>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <p style={{
                ...
                Al tomar este caso, la solicitud pasará a <strong>EN_ANÁLISIS</strong> y se moverá a la sección de "En Proceso". ¿Deseas continuar?
              </p>
            </div>
              ...
              <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '8px 20px',
                    border: 'none',
                    background: pending ? '#a78bfa' : '#7c3aed',
                    color: '#ffffff',
                    cursor: pending ? 'not-allowed' : 'pointer',
                  }}
                >
                  {pending ? 'Procesando...' : 'Tomar Caso'}
                </button>
              </div>
            </form>
          </div>
