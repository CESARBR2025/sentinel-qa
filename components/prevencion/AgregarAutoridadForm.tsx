...
const I: React.CSSProperties = {
  width: '100%', padding: '8px 12px', background: '#070b16',
...
export function AgregarAutoridadForm({ medidaId, autoridadPrincipal, yaAgregadas }: Props) {
  ...
  if (disponibles.length === 0) {
    return (
      <p style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: 10, color: '#2a3a5e', letterSpacing: '0.12em', textTransform: 'uppercase', margin: 0 }}>
    ...
    <>
      {!open ? (
        ...
        <form
          ...
          style={{ background: '#070b16', border: '1px solid #1b2742', padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 14 }}
        >
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              ...
              style={{
                padding: '7px 18px',
                background: pending ? '#1b2742' : '#c0223a',
                color: pending ? '#4a5878' : '#fff',
