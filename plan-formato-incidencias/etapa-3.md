# Etapa 3 — Navegación: card en el hub `/formatos-udai`

Depende de Etapa 2 (para que la ruta destino tenga datos reales cuando se navegue; esta etapa por sí sola solo agrega el link).
