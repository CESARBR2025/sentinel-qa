...
- "incidentes_repository": "repository.ts" | kind=code-symbol | source=lib/incidentes/repository.ts:L1 | neighbors=[route.ts, 13f7f39 Reporte-incidentes, 22b7b54 Merge branch 'feature/reportes'…, 290d651 feat(despacho): flujo integral …, 552d291 Merge branch 'testing' into con…, 5ef7cf3 Agregar los campos faltantes] | lang=en
...
- "incidentes_page": "page.tsx" | kind=code-symbol | source=app/incidentes/page.tsx:L1 | neighbors=[03f8b2a implementado rbac, 046f18c Merge pull request #19 from pre…, 27dcb21 Merge branch 'feature/testing' …, 290d651 feat(despacho): flujo integral …, 44ebbc4 Merge branch 'feature/testing' …, 514a705 refactorizacion sql] | lang=en
