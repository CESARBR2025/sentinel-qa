# Node Description Batch 1 of 93
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@863c575db4bdcf8fbc48703d7e6865953771dc43": "863c575 Merge pull request #24 from presidenciaSJR/feature/testing" | kind=Commit | source=git | neighbors=[2e36377 Eliminar tutoriales de flujo in…, 7e39526 Mejoras UI/UX, FiltrosIncidentes.tsx, mapper.ts, ModuleCard.tsx, Pagination.tsx] | lang=en
- "id_page": "page.tsx" | kind=code-symbol | source=app/prevencion/medidas/[id]/page.tsx:L1 | neighbors=[0068216 Mejora de Dashboard, Login y tr…, 03f8b2a implementado rbac, 046f18c Merge pull request #19 from pre…, 06c55f5 Merge branch 'feature/testing' …, 0b210fa Merge pull request #12 from pre…, 0c31cc2 Merge branch 'testing' into juz…] | lang=en
- "branch:repo:github.com/presidenciaSJR/seguridad_publica#feature/testing": "feature/testing" | kind=Branch | source=git | neighbors=[0068216 Mejora de Dashboard, Login y tr…, 03f8b2a implementado rbac, 046f18c Merge pull request #19 from pre…, 067c4de arreglando flujo de fiscalia  a…, 06c55f5 Merge branch 'feature/testing' …, 07543de Conexion de reportes con d1 y l…] | lang=en
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@0068216cfed92f7524524a356ff56a42fe625df2": "0068216 Mejora de Dashboard, Login y transiciones de pantallas" | kind=Commit | source=git | neighbors=[ModuleCard.tsx, layout.tsx, layout.tsx, ModalReactivarOficial.tsx, OficialesTable.tsx, page.tsx] | lang=nl
...
- "nuevo_page": "page.tsx" | kind=code-symbol | source=app/oficial/nuevo/page.tsx:L1 | neighbors=[0068216 Mejora de Dashboard, Login y tr…, 067c4de arreglando flujo de fiscalia  a…, 06c55f5 Merge branch 'feature/testing' …, 0c31cc2 Merge branch 'testing' into juz…, 0d9172a mejorando flujo de 911-despacho, 0e33bf6 feat: módulo Admin, Prórroga, F…] | lang=en
...
- "oficial_service": "service.ts" | kind=code-symbol | source=lib/oficial/service.ts:L1 | neighbors=[route.ts, page.tsx, 067c4de arreglando flujo de fiscalia  a…, 0c31cc2 Merge branch 'testing' into juz…, 0d9172a mejorando flujo de 911-despacho, 13f7f39 Reporte-incidentes] | lang=en
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@ad3ec5f3be685ac0390b1bb26ed1b4e4ee446256": "ad3ec5f mejorando esto" | kind=Commit | source=git | neighbors=[repository.ts, repository.ts, route.ts, route.ts, feature/testing, main] | lang=en
...
- "incidentes_actions": "actions.ts" | kind=code-symbol | source=lib/incidentes/actions.ts:L1 | neighbors=[Formulario911.tsx, 03f8b2a implementado rbac, 046f18c Merge pull request #19 from pre…, 09a02d5 Fix Reporte Rondin, 0c31cc2 Merge branch 'testing' into juz…, 0d9172a mejorando flujo de 911-despacho] | lang=en
...
- "fiscalia_service": "service.ts" | kind=code-symbol | source=lib/fiscalia/service.ts:L1 | neighbors=[actions.ts, 067c4de arreglando flujo de fiscalia  a…, 090c4dd vista de fiscalia, 16a63d4 Merge branch 'feature/testing' …, 1f7c0d7 Merge pull request #23 from pre…, 2db162a flujo de asegurados] | lang=en
- "monitorista_repository": "repository.ts" | kind=code-symbol | source=lib/monitorista/repository.ts:L1 | neighbors=[514a705 refactorizacion sql, 863c575 Merge pull request #24 from pre…, 8ce87da Cambios en todos los headers, ad3ec5f mejorando esto, c27a9ee fase prefinal, route.ts] | lang=en
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@f7b1aacd08a138818884c835b5627b6fdae25f5f": "f7b1aac Merge branch 'feature/testing' of https://github.com/presidenciaSJR/seg…" | kind=Commit | source=git | neighbors=[27dcb21 Merge branch 'feature/testing' …, 56b6577 FORMULARIO SE ENLAZO A LA TABLA…, route.ts, feature/testing, main, route.ts] | lang=en
...
- "fiscalia_repository": "repository.ts" | kind=code-symbol | source=lib/fiscalia/repository.ts:L1 | neighbors=[actions.ts, 067c4de arreglando flujo de fiscalia  a…, 090c4dd vista de fiscalia, 16a63d4 Merge branch 'feature/testing' …, 1f7c0d7 Merge pull request #23 from pre…, 2db162a flujo de asegurados] | lang=en

## Instructions

Write a single JSON object mapping each node id to a one-sentence description
to: /Users/ugomez/Documents/GitHub/seguridad_publica/.graphify/description-instructions/batch-000.json
