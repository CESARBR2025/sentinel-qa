# Node Description Batch 8 of 89
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@13f7f399992e81fb151dbac5fefc1deb171b965c": "13f7f39 Reporte-incidentes" | kind=Commit | source=git | neighbors=[feature/testing, 27dcb21 Merge branch 'feature/testing' …, route.ts, actions.ts, FiltrosIncidencias.tsx, repository.ts] | lang=en
...
- "despacho_tablondespacho": "TablonDespacho.tsx" | kind=code-symbol | source=components/911/despacho/TablonDespacho.tsx:L1 | neighbors=[0d9172a mejorando flujo de 911-despacho, 22bf125 Merge pull request #20 from pre…, 290d651 feat(despacho): flujo integral …, 511fea4 Modulo de despacho, page.tsx, DespachoForm.tsx] | lang=en
...
- "scripts_trace_client": "trace-client.mjs" | kind=code-symbol | source=scripts/trace-client.mjs:L1 | neighbors=[22bf125 Merge pull request #20 from pre…, 3c12c41 cambios en flujo de 911-despacho, buildHelperCode(), components, __dirname, dirty] | lang=en
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@07543deef08b193525fe36cc4a9e2572606ece35": "07543de Conexion de reportes con d1 y los diarios, mensuales y semanales" | kind=Commit | source=git | neighbors=[feature/testing, 1acddac Merge branch 'feature/testing' …, D1Filters.tsx, D1ReportsTable.tsx, page.tsx, repository.ts] | lang=es
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@11be750b77ec68eaf2e0a3a4c0446aa9a201a161": "11be750 Fase 1 de correccion - completada - pendiente testing" | kind=Commit | source=git | neighbors=[actions.ts, actions.ts, actions.ts, feature/testing, ffcea0c fase 1 completada, actions.ts] | lang=nl
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@5a1b5d59c49de0856d3a09a05af0c3781d718690": "5a1b5d5 empezando corralon" | kind=Commit | source=git | neighbors=[feature/testing, f5fac0b Merge branch 'testing' into con…, actions.ts, layout.tsx, module-card.tsx, page.tsx] | lang=pt
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@5ed311a75808b99e806e1f6fae238fec714aaa6d": "5ed311a Merge pull request #5 from presidenciaSJR/fix/detenidos" | kind=Commit | source=git | neighbors=[23a3b9d Cambios en la estructura de los…, 5abc683 Merge branch 'feature/auxiliar'…, feature/testing, fix/incidentes-camara, fix/subir-fotografias, 810844a Cambios en la estructura de los…] | lang=en
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@23a3b9db16f36971ecf13d363a5e05b58fbad045": "23a3b9d Cambios en la estructura de los reportes de los detenidos" | kind=Commit | source=git | neighbors=[feature/testing, fix/detenidos, fix/incidentes-camara, fix/subir-fotografias, 5ed311a Merge pull request #5 from pres…, page.tsx] | lang=es
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@5ef7cf3542628cc5d6a4fb8cc32b9a2856a05bf5": "5ef7cf3 Agregar los campos faltantes" | kind=Commit | source=git | neighbors=[4c9fa8a vista de reporte de d1 no inici…, feature/testing, 0b210fa Merge pull request #12 from pre…, 712c116 Merge branch 'testing' into con…, ef95840 Merge branch 'feature/testing' …, f6954ec Conexion a la bd y la generacio…] | lang=es
