...
- "solicitudes_page": "page.tsx" | kind=code-symbol | source=app/monitorista/solicitudes/page.tsx:L1 | neighbors=[0068216 Mejora de Dashboard, Login y tr…, 090c4dd vista de fiscalia, 1f7c0d7 Merge pull request #23 from pre…, 27dcb21 Merge branch 'feature/testing' …, 375d265 flujo de fiscalia, 3ec7484 Header y Footer Fix] | lang=en
...
- "partials_header": "Header.tsx" | kind=code-symbol | source=components/partials/Header.tsx:L1 | neighbors=[page.tsx, page.tsx, page.tsx, page.tsx, page.tsx, page.tsx] | lang=en
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@3ec748440c3a4906bbef36567c76624342f947c1": "3ec7484 Header y Footer Fix" | kind=Commit | source=git | neighbors=[permisos.ts, actions.ts, layout.tsx, layout.tsx, page.tsx, service.ts] | lang=es
...
- "auth_helpers": "helpers.ts" | kind=code-symbol | source=lib/auth/helpers.ts:L1 | neighbors=[actions.ts, layout.tsx, page.tsx, page.tsx, page.tsx, page.tsx] | lang=en
...
- "solicitudid_page": "page.tsx" | kind=code-symbol | source=app/fiscalia/solicitudes/[solicitudId]/page.tsx:L1 | neighbors=[0068216 Mejora de Dashboard, Login y tr…, 1f7c0d7 Merge pull request #23 from pre…, 375d265 flujo de fiscalia, 3ec7484 Header y Footer Fix, 5f13b34 Merge branch 'feature/testing' …, 6109a7a replicando flujo para fiscalia] | lang=en
...
- "detenidos_page": "page.tsx" | kind=code-symbol | source=app/monitorista/detenidos/page.tsx:L1 | neighbors=[0068216 Mejora de Dashboard, Login y tr…, 23a3b9d Cambios en la estructura de los…, 27dcb21 Merge branch 'feature/testing' …, 388b997 Apartados para subir fotografia…, 3ec7484 Header y Footer Fix, 5618308 guardado e evidencias con ed] | lang=en
...
- "partials_header_dashboardheader": "DashboardHeader()" | kind=code-symbol | source=components/partials/Header.tsx:L27 | neighbors=[page.tsx, page.tsx, page.tsx, page.tsx, page.tsx, page.tsx] | lang=en
