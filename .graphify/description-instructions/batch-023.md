...
- "generar_route_tablafiscalia": "tablaFiscalia()" | kind=code-symbol | source=app/api/nCoordinacion/generar/route.ts:L60 | neighbors=[route.ts, GET(), dRow(), hRow(), toN()]
...
- "permisos_core_tienepermiso": "tienePermiso()" | kind=code-symbol | source=lib/permisos/core.ts:L58 | neighbors=[actions.ts, layout.tsx, core.ts, obtenerPermisosUsuario(), route.ts]
