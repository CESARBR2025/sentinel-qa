...
- "fotos_page_fotosdetenidopage": "FotosDetenidoPage()" | kind=code-symbol | source=app/oficial/reportes/[id]/fotos/page.tsx:L11 | neighbors=[page.tsx]
- "fuente_route_get": "GET()" | kind=code-symbol | source=app/api/reportes/formato-n-rnd/fuente/route.ts:L7 | neighbors=[route.ts]
- "generar_orden_pago_route_post": "POST()" | kind=code-symbol | source=app/api/via/sa7/generar-orden-pago/route.ts:L12 | neighbors=[route.ts]
...
- "generar_route_alignment": "Alignment" | kind=code-symbol | source=app/api/nCoordinacion/generar/route.ts:L26 | neighbors=[route.ts]
- "generar_route_allborders": "allBorders" | kind=code-symbol | source=app/api/nCoordinacion/generar/route.ts:L19 | neighbors=[route.ts]
- "generar_route_no_border": "NO_BORDER" | kind=code-symbol | source=app/api/nCoordinacion/generar/route.ts:L17 | neighbors=[route.ts]
- "generar_route_noborders": "noBorders" | kind=code-symbol | source=app/api/nCoordinacion/generar/route.ts:L20 | neighbors=[route.ts]
- "generar_route_thin": "THIN" | kind=code-symbol | source=app/api/nCoordinacion/generar/route.ts:L18 | neighbors=[route.ts]
- "gruas_route_get": "GET()" | kind=code-symbol | source=app/api/complementos/gruas/route.ts:L6 | neighbors=[route.ts]
- "guardar_evidencias_route_post": "POST()" | kind=code-symbol | source=app/api/via/exp-digital/guardar-evidencias/route.ts:L8 | neighbors=[route.ts]
...
- "id_page_aseguradodetallepage": "AseguradoDetallePage()" | kind=code-symbol | source=app/fiscalia/asegurados/[id]/page.tsx:L32 | neighbors=[page.tsx]
- "id_page_atenderdespachopage": "AtenderDespachoPage()" | kind=code-symbol | source=app/oficial/despachos/[id]/page.tsx:L11 | neighbors=[page.tsx]
- "id_page_btn": "BTN" | kind=code-symbol | source=app/auxiliar/checklist/[id]/page.tsx:L13 | neighbors=[page.tsx]
...
- "id_page_campo": "Campo()" | kind=code-symbol | source=app/monitorista/detenidos/[id]/page.tsx:L120 | neighbors=[page.tsx]
