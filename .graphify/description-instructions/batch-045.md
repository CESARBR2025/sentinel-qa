# Node Description Batch 46 of 93
...
- "incidentes_types_despachodetalleresponse": "DespachoDetalleResponse" | kind=code-symbol | source=lib/incidentes/types.ts:L206 | neighbors=[mapper.ts, types.ts]
- "incidentes_types_reportedetalleresponse": "ReporteDetalleResponse" | kind=code-symbol | source=lib/incidentes/types.ts:L240 | neighbors=[mapper.ts, types.ts]
...
- "maps_loadgooglemaps_getmapswindow": "getMapsWindow()" | kind=code-symbol | source=lib/maps/loadGoogleMaps.ts:L12 | neighbors=[loadGoogleMaps.ts, loadGoogleMaps()]
- "maps_loadgooglemaps_googlemapswindow": "GoogleMapsWindow" | kind=code-symbol | source=lib/maps/loadGoogleMaps.ts:L5 | neighbors=[loadGoogleMaps.ts, Window]
- "maps_loadgooglemaps_waitforgoogle": "waitForGoogle()" | kind=code-symbol | source=lib/maps/loadGoogleMaps.ts:L16 | neighbors=[loadGoogleMaps.ts, loadGoogleMaps()]
