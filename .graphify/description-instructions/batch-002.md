...
- "oficial_actions": "actions.ts" | kind=code-symbol | source=lib/oficial/actions.ts:L1 | neighbors=[0c31cc2 Merge branch 'testing' into juz…, 16a63d4 Merge branch 'feature/testing' …, 290d651 feat(despacho): flujo integral …, 388b997 Apartados para subir fotografia…, 44ebbc4 Merge branch 'feature/testing' …, 458bbfb registro de reporte de campo - …] | lang=en
...
- "incidentes_mapper": "mapper.ts" | kind=code-symbol | source=lib/incidentes/mapper.ts:L1 | neighbors=[290d651 feat(despacho): flujo integral …, ad3ec5f mejorando esto, rowToAlarmaEscolar(), rowToDespacho(), rowToDespachoElemento(), rowToDespachoUnidad()] | lang=en
...
- "oficial_mapper": "mapper.ts" | kind=code-symbol | source=lib/oficial/mapper.ts:L1 | neighbors=[067c4de arreglando flujo de fiscalia  a…, 0c31cc2 Merge branch 'testing' into juz…, 16a63d4 Merge branch 'feature/testing' …, 290d651 feat(despacho): flujo integral …, 44ebbc4 Merge branch 'feature/testing' …, 458bbfb registro de reporte de campo - …] | lang=en
- "partials_header": "Header.tsx" | kind=code-symbol | source=components/partials/Header.tsx:L1 | neighbors=[page.tsx, page.tsx, page.tsx, 03f8b2a implementado rbac, 046f18c Merge pull request #19 from pre…, ac9ad49 Merge branch 'feature/testing' …] | lang=en
...
- "incidentes_service": "service.ts" | kind=code-symbol | source=lib/incidentes/service.ts:L1 | neighbors=[13f7f39 Reporte-incidentes, 22b7b54 Merge branch 'feature/reportes'…, 290d651 feat(despacho): flujo integral …, 552d291 Merge branch 'testing' into con…, 5ef7cf3 Agregar los campos faltantes, 712c116 Merge branch 'testing' into con…] | lang=en
