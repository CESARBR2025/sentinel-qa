# Node Description Batch 65 of 93
...
- "components_pagetransition_pagetransition": "PageTransition()" | kind=code-symbol | source=components/PageTransition.tsx:L22 | neighbors=[PageTransition.tsx]
- "components_pagetransition_stage": "Stage" | kind=code-symbol | source=components/PageTransition.tsx:L14 | neighbors=[PageTransition.tsx]
...
- "components_smoothscroll_smoothscroll": "SmoothScroll()" | kind=code-symbol | source=components/SmoothScroll.tsx:L5 | neighbors=[SmoothScroll.tsx]
