...
- "despacho_tablondespacho": "TablonDespacho.tsx" | kind=code-symbol | source=components/911/despacho/TablonDespacho.tsx:L1 | neighbors=[511fea4 Modulo de despacho, DespachoForm.tsx, DespachoForm(), btnBackStyle, CanalBadge(), IncRow] | lang=en
