# Node Description Batch 27 of 79
...
- "incidentes_actions_deletepersonaafectada": "deletePersonaAfectada()" | kind=code-symbol | source=lib/incidentes/actions.ts:L188 | neighbors=[actions.ts, req(), requireOperador()]
