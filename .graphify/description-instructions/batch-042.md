# Node Description Batch 43 of 89
...
- "incidentes_actions_cerrarpordetencion": "cerrarPorDetencion()" | kind=code-symbol | source=lib/incidentes/actions.ts:L621 | neighbors=[actions.ts, requireOperador()]
- "incidentes_actions_marcarensitio": "marcarEnSitio()" | kind=code-symbol | source=lib/incidentes/actions.ts:L599 | neighbors=[actions.ts, requireOperador()]
