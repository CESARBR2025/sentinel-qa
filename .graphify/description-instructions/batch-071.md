# Node Description Batch 72 of 79
...
- "oficial_service_bool": "bool()" | kind=code-symbol | source=lib/oficial/service.ts:L27 | neighbors=[service.ts]
- "oficial_service_str": "str()" | kind=code-symbol | source=lib/oficial/service.ts:L23 | neighbors=[service.ts]
