# Node Description Batch 17 of 89
...
- "scripts_export_schema": "export-schema.mjs" | kind=code-symbol | source=scripts/export-schema.mjs:L1 | neighbors=[0d9172a mejorando flujo de 911-despacho, 22bf125 Merge pull request #20 from pre…, __dirname, getColumns(), getEnums(), getSchemas()] | lang=en
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@0caf5dd72e9d67acad76dd1b85267da65b6518c0": "0caf5dd Fixes" | kind=Commit | source=git | neighbors=[feature/testing, 0d9172a mejorando flujo de 911-despacho, 22bf125 Merge pull request #20 from pre…, mapper.ts, repository.ts, semaforo.ts] | lang=en
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@11ee4f2b2cc1ba889f6389920403a97b2cd1c654": "11ee4f2 mejorando flujo de 911" | kind=Commit | source=git | neighbors=[feature/testing, 6c646af fix loader bug en login, extract-domain.mjs, load-context.mjs, trace-components.mjs, trace-server.mjs] | lang=nl
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@3c12c416b0186391bd45cf0c526368c9292bc981": "3c12c41 cambios en flujo de 911-despacho" | kind=Commit | source=git | neighbors=[feature/testing, 7a1ae94 911-rondin, context-loader.js, populate-vault.mjs, trace-client.mjs, trace-server.mjs] | lang=nl
...
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@e6bffc94cb627a96f24106c5c71c5914defb40fa": "e6bffc9 boveda conectada" | kind=Commit | source=git | neighbors=[c27a9ee fase prefinal, feature/testing, a7a7f2e boveda, graphify.js, exportar-schema.ts, extract-domain.mjs] | lang=en
- "commit:repo:github.com/presidenciaSJR/seguridad_publica@ea0242b7aa39a9b85d47f1d1346cb064b98394be": "ea0242b vista de juridico" | kind=Commit | source=git | neighbors=[c471e9c Merge pull request #15 from pre…, feature/testing, 8355ac0 Merge branch 'feature/testing' …, page.tsx, page.tsx, ContestacionForm.tsx] | lang=nl
...
- "despachos_page": "page.tsx" | kind=code-symbol | source=app/oficial/despachos/page.tsx:L1 | neighbors=[0d9172a mejorando flujo de 911-despacho, 22bf125 Merge pull request #20 from pre…, 290d651 feat(despacho): flujo integral …, MisDespachosPage(), auth.ts, auth] | lang=en
