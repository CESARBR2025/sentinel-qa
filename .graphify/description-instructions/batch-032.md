...
- "oficial_repository_obtenerreportecamposimple": "obtenerReporteCampoSimple()" | kind=code-symbol | source=lib/oficial/repository.ts:L389 | neighbors=[page.tsx, repository.ts, route.ts]
...
- "oficial_service_listardespachosasignados": "listarDespachosAsignados()" | kind=code-symbol | source=lib/oficial/service.ts:L214 | neighbors=[page.tsx, page.tsx, service.ts]
- "oficial_service_obtenermiperfil": "obtenerMiPerfil()" | kind=code-symbol | source=lib/oficial/service.ts:L83 | neighbors=[page.tsx, service.ts, page.tsx]
...
- "permisos_core_guardarpermiso": "guardarPermiso()" | kind=code-symbol | source=lib/permisos/core.ts:L85 | neighbors=[core.ts, aplicarPlantillaRol(), guardarPermisosSeccionesAction()]
- "permisos_core_mapabase": "mapaBase()" | kind=code-symbol | source=lib/permisos/core.ts:L26 | neighbors=[core.ts, obtenerPermisosUsuario(), obtenerPlantillaRol()]
...
- "permisos_core_requireadmin": "requireAdmin()" | kind=code-symbol | source=lib/permisos/core.ts:L156 | neighbors=[core.ts, guardarPermisosSeccionesAction(), guardarPlantillaSeccionesAction()]
