# Node Description Batch 59 of 93
...
- "agente_911_page_agente911dashboardpage": "Agente911DashboardPage()" | kind=code-symbol | source=app/agente_911/page.tsx:L12 | neighbors=[page.tsx]
- "agente_bitacorista_page_agentebitacoristadashboardpage": "AgenteBitacoristaDashboardPage()" | kind=code-symbol | source=app/agente_bitacorista/page.tsx:L12 | neighbors=[page.tsx]
- "agente_despacho_page_agentedespachodashboardpage": "AgenteDespachoDashboardPage()" | kind=code-symbol | source=app/agente_despacho/page.tsx:L12 | neighbors=[page.tsx]
...
- "agente_infracciones_page_infraccionesdashboardpage": "InfraccionesDashboardPage()" | kind=code-symbol | source=app/agente_infracciones/page.tsx:L9 | neighbors=[page.tsx]
...
- "agente_infracciones_repository_infraccionupdaterow": "InfraccionUpdateRow" | kind=code-symbol | source=lib/agente_infracciones/repository.ts:L27 | neighbors=[repository.ts]
- "agente_infracciones_service_sa7_url": "SA7_URL" | kind=code-symbol | source=lib/agente_infracciones/service.ts:L7 | neighbors=[service.ts]
...
to: /Users/ugomez/Documents/GitHub/seguridad_publica/.graphify/description-instructions/batch-058.json
