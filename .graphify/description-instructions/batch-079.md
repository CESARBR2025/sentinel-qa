# Node Description Batch 80 of 93
...
- "n_coordinacion_actions_str": "str()" | kind=code-symbol | source=lib/n-coordinacion/actions.ts:L8 | neighbors=[actions.ts]
- "ncoordinacion_page_card": "CARD" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L15 | neighbors=[page.tsx]
- "ncoordinacion_page_g3": "G3" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L17 | neighbors=[page.tsx]
- "ncoordinacion_page_inp": "INP" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L13 | neighbors=[page.tsx]
- "ncoordinacion_page_lbl": "LBL" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L12 | neighbors=[page.tsx]
- "ncoordinacion_page_ncoordinacionpage": "NCoordinacionPage()" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L28 | neighbors=[page.tsx]
- "ncoordinacion_page_num": "NUM" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L14 | neighbors=[page.tsx]
- "ncoordinacion_page_numfield": "NumField()" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L19 | neighbors=[page.tsx]
- "ncoordinacion_page_sec": "SEC" | kind=code-symbol | source=app/nCoordinacion/page.tsx:L16 | neighbors=[page.tsx]
- "ncoordinacion_profiledropdowncoordinacion_props": "Props" | kind=code-symbol | source=components/nCoordinacion/ProfileDropdownCoordinacion.tsx:L8 | neighbors=[ProfileDropdownCoordinacion.tsx]
