...
## Corpus Check
- Large corpus: 777 files · ~554,658 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3405 nodes · 11314 edges · 127 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: MODIFIES: 3746 · contains: 2557 · imports: 1822 · imports_from: 1220 · ON_BRANCH: 1207 · calls: 358 · PARENT_OF: 307 · re_exports: 52 · method: 29 · references: 9 · inherits: 7


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 777 · Candidates: 832
- Excluded: 1 untracked · 73581 ignored · 0 sensitive · 30 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `eacfdaf`
...
Cohesion: 0.05
Nodes (31): getStats(), verificarRolAgente911(), verificarRolAgenteBitacorista(), verificarRolAgenteDespacho(), { GET, POST }, getUserWithRole(), rowToUserWithRole(), UserWithRole (+23 more)
...
Cohesion: 0.07
Nodes (29): db, Accion, registrarAudit(), query(), obtenerIphDetenido(), obtenerPrellenadoCompleto(), obtenerSolicitudConEvidencias(), obtenerPrellenado() (+21 more)
...
Cohesion: 0.07
Nodes (25): Accion, obtenerRolNombre(), PermisoSeccion, ROLES_PERMITIDOS, Seccion, SECCIONES, tieneAccesoHub(), tieneAccesoSeccion() (+17 more)
...
Cohesion: 0.13
Nodes (8): 6feefe2 BackEnd completo para hacer la conección con la BD, 71912a4 Bitacora incluida, 82ae6e9 Interfaz de llamada 911 cambios, a58a0f7 Despachos, IncidenteDetalle, Filtros, IncidenteResumen, ReporteCampoDetalle
...
Cohesion: 0.18
Nodes (10): libraries, 0844e6e Corregido, 4d4a9b7 formulario de notificaciones por radio, 72e8913 cambio de diseño, 7f3fe1a Formulariop de Rondines listo, falta revisarlo PERO YA ES FUNCIONAL, 95b78c1 cambios de incidentes, eacfdaf mostrando toast de guardado, ef9e0ea Formulario arreglado (+2 more)
...
Cohesion: 0.23
Nodes (10): actualizarAtencionVictimas(), crearAtencionVictimas(), formatFecha(), FormatoNAtencionVictimasInput, listarAtencionVictimas(), obtenerAtencionVictimas(), obtenerAtencionVictimasPorFechaPeriodo(), parsePeriodo() (+2 more)
...
## Knowledge Gaps
- **723 isolated node(s):** `__dirname`, `ROOT`, `GRAPH_PATH`, `CHECKPOINT_SCRIPT`, `GOLDEN_RULES` (+718 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 88`** (2 nodes): `LogLine`, `LogType`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `CWD`, `__dirname`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (2 nodes): `DC`, `DCCtx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `WF`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (1 nodes): `TWEAKS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 120`** (2 nodes): `ADMIN`, `pool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (2 nodes): `obtenerTokenFiscalia()`, `subirArchivoFiscalia()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `auth` connect `Community 2` to `Community 33`, `Community 54`, `Community 55`, `Community 25`, `Community 6`, `Community 24`, `Community 34`, `Community 1`, `Community 28`, `Community 48`, `Community 0`, `Community 56`, `Community 15`, `Community 30`, `Community 9`, `Community 12`, `Community 14`, `Community 17`, `Community 38`, `Community 93`, `Community 40`, `Community 43`, `Community 29`, `Community 13`, `Community 70`, `Community 81`, `Community 23`, `Community 61`, `Community 82`, `Community 3`, `Community 27`, `Community 51`, `Community 32`, `Community 22`, `Community 19`, `Community 41`, `Community 122`, `Community 63`, `Community 8`, `Community 83`, `Community 5`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `query()` connect `Community 23` to `Community 28`, `Community 66`, `Community 39`, `Community 54`, `Community 46`, `Community 2`, `Community 31`, `Community 6`, `Community 24`, `Community 50`, `Community 68`, `Community 43`, `Community 55`, `Community 9`, `Community 79`, `Community 16`, `Community 30`, `Community 64`, `Community 27`, `Community 7`, `Community 41`, `Community 73`, `Community 17`, `Community 4`, `Community 32`, `Community 14`, `Community 59`, `Community 12`, `Community 1`, `Community 20`, `Community 122`, `Community 0`, `Community 81`, `Community 62`, `Community 26`, `Community 93`, `Community 90`, `Community 33`, `Community 8`, `Community 48`, `Community 34`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `SA7Repository` connect `Community 48` to `Community 61`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.02947777944037109 - nodes in this community are weakly interconnected._
