...
## Corpus Check
- Large corpus: 769 files · ~547,621 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 3327 nodes · 11181 edges · 124 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: MODIFIES: 3714 · contains: 2488 · imports: 1815 · imports_from: 1214 · ON_BRANCH: 1205 · calls: 343 · PARENT_OF: 305 · re_exports: 52 · method: 29 · references: 9 · inherits: 7


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 769 · Candidates: 822
- Excluded: 9 untracked · 73162 ignored · 0 sensitive · 30 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `0caf5dd`
...
Cohesion: 0.03
Nodes (100): 06c55f5 Merge branch 'feature/testing' into feature/reportes, 1e81ec8 Datos se autorellenan de denuncias y seccion de oficial, 41ea169 Merge branch 'testing' into conexion, 8355ac0 Merge branch 'feature/testing' into feature/implementacion-consumir-datos-denuncia, bb10dcd Formatos V1, c95f412 Merge branch 'feature/testing' of https://github.com/presidenciaSJR/seguridad_publica into feature/testing, filtroBtn(), FormatoNFgePage() (+92 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (39): tieneAccesoSeccion(), getCatalogos(), getStats(), verificarRolAgente911(), verificarRolAgenteBitacorista(), verificarRolAgenteDespacho(), { GET, POST }, getUserWithRole() (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (51): TIPO_CFG, 5558751 feat: módulo Prevención del Delito completo + fix flujo autenticación 2FA, 5618308 guardado e evidencias con ed, 77ddf58 Merge branch 'feature/testing' of https://github.com/presidenciaSJR/seguridad_publica into feature/testing, f2c66e6 Extender roles y permisos finos a incidentes, prevención, auxiliar, 911, análisis, denuncia D1 y Formato N, fmtDT(), ImprimirFichaPage(), monitorista_permisos (+43 more)
...
Cohesion: 0.12
Nodes (53): conexion, feature/testing, testing, 0c8695c Cambios en filtros, 0caf5dd Fixes, 1265204 paginacion por tablas, 160d1e1 Monitorista V1.1, 18f5bac llamada en card (+45 more)
...
Cohesion: 0.08
Nodes (46): 290d651 feat(despacho): flujo integral 911 → despacho → oficial → D1 → legal, parseJsonField(), rowToD1(), rowToDespachoAsignado(), rowToOficial(), rowToReporteCampo(), rowToReporteDetalle(), rowToReporteResumen() (+38 more)
...
Cohesion: 0.19
Nodes (49): feature/monitorista-reportes, fix/detenidos, fix/incidentes-camara, fix/subir-fotografias, main, 0e33bf6 feat: módulo Admin, Prórroga, Filtros medidas, Autoridades adicionales y Notificaciones/Alertas, 0fe445e vista de oficial, 11e8817 Merge branch 'testing' into juzgado (+41 more)
...
Cohesion: 0.06
Nodes (31): btnPrimario, btnSecundario, inputStyle, labelStyle, pageWrap, selectStyle, btnPrimario(), btnSecundario (+23 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (20): a2e0623 Consolidado de formatos N y SubHeader, ajustes en servicios de reportes, f5fac0b Merge branch 'testing' into conexion, SignOutButton(), filtroBtn(), FormatoNAtencionVictimasPage(), filtroBtn(), FormatoNFgrPage(), filtroBtn() (+12 more)
...
Cohesion: 0.06
Nodes (24): Accion, obtenerRolNombre(), PermisoSeccion, ROLES_PERMITIDOS, Seccion, SECCIONES, tieneAccesoHub(), tienePermiso() (+16 more)
...
Cohesion: 0.10
Nodes (28): 0c31cc2 Merge branch 'testing' into juzgado, 13f7f39 Reporte-incidentes, 458bbfb registro de reporte de campo - oficial, 93dd3ea Merge pull request #1 from presidenciaSJR/juzgado, 9d803f2 fix api maps, aaddee5 Merge branch 'feature/testing' into feature/denuncias, b79a96a Conexión entre ambos modulos, fcb223f merge de testing (+20 more)
...
Cohesion: 0.10
Nodes (14): btnNuevoStyle, btnViewStyle, cardStyle, decoratorStyle, footerStyle, headerInnerStyle, ROLES_PERMITIDOS, SearchParams (+6 more)
...
Cohesion: 0.20
Nodes (12): rowToCatalogo(), listarIncidentes(), listarIncidentesRecientes(), obtenerCatalogos(), obtenerIncidente(), obtenerIncidenteConExtras(), obtenerStats(), obtenerTiposIncidente() (+4 more)
...
Cohesion: 0.24
Nodes (6): OptionSquare(), getEnvioFormatosCount(), getFormatoNStats(), getIncidentesCount(), FormatoNStats, SentinelHero()
...
Cohesion: 0.20
Nodes (9): addAutoridadMedida(), AgregarAutoridadForm(), Autoridad, AUTORIDADES, I, L, Props, AutoridadBadge() (+1 more)
...
Cohesion: 0.39
Nodes (7): rowToIncidenteDetalle(), rowToIncidenteResumen(), toNum(), toStr(), CatalogoItem, IncidenteDetalle, IncidenteResumen
...
Cohesion: 0.25
Nodes (6): createRondinEscalado(), ahoraLocal(), CatalogoItem, FormRondinEscalado(), inputStyle, Props
...
## Knowledge Gaps
- **700 isolated node(s):** `__dirname`, `ROOT`, `CONTEXT_MAP_PATH`, `GRAPH_JSON`, `LOADER_SCRIPT` (+695 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 87`** (2 nodes): `LogLine`, `LogType`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `DC`, `DCCtx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `WF`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `TWEAKS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `TWEAKS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (2 nodes): `cancelarFicha()`, `CancelacionModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `MAIN_ROUTES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (2 nodes): `ADMIN`, `pool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (2 nodes): `obtenerTokenFiscalia()`, `subirArchivoFiscalia()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (2 nodes): `ProrrogaViewerModal()`, `ProrrogaViewerModalProps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `eslintConfig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `auth` connect `Community 1` to `Community 32`, `Community 52`, `Community 53`, `Community 23`, `Community 8`, `Community 22`, `Community 33`, `Community 2`, `Community 25`, `Community 48`, `Community 0`, `Community 54`, `Community 14`, `Community 28`, `Community 10`, `Community 13`, `Community 15`, `Community 16`, `Community 38`, `Community 91`, `Community 40`, `Community 43`, `Community 26`, `Community 5`, `Community 55`, `Community 20`, `Community 80`, `Community 60`, `Community 81`, `Community 3`, `Community 34`, `Community 58`, `Community 31`, `Community 19`, `Community 27`, `Community 41`, `Community 9`, `Community 62`, `Community 7`, `Community 82`, `Community 21`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `query()` connect `Community 1` to `Community 25`, `Community 71`, `Community 39`, `Community 52`, `Community 46`, `Community 29`, `Community 8`, `Community 22`, `Community 50`, `Community 66`, `Community 43`, `Community 53`, `Community 10`, `Community 78`, `Community 5`, `Community 28`, `Community 63`, `Community 34`, `Community 6`, `Community 41`, `Community 73`, `Community 16`, `Community 4`, `Community 31`, `Community 15`, `Community 57`, `Community 13`, `Community 2`, `Community 18`, `Community 9`, `Community 0`, `Community 80`, `Community 61`, `Community 24`, `Community 91`, `Community 88`, `Community 32`, `Community 7`, `Community 48`, `Community 33`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `SA7Repository` connect `Community 48` to `Community 60`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.028635346756152126 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.046781287485006 - nodes in this community are weakly interconnected._
